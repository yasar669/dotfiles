...
# NOT: Eski Bolum 5 (WSS SignalR adaptor fonksiyonlari) ve
# adaptor_hisse_bilgi_al fonksiyonu tvDatafeed gecisi
# kapsaminda kaldirilmistir. Canli fiyat verisi artik
# tvDatafeed uzerinden saglanmaktadir.
# Bkz: tarama/_tvdatafeed_canli.py ve tarama/canli_veri.sh
